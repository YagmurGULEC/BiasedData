...
def analyze_data(df):
    # Create a prompt with the summary text

    messages = [
        {"role": "system", "content": "You are an expert data analyst."},
        {"role": "user", "content": "Can you examine demographic representation especially gender, and check for disparities in outcomes   \n"+df.sample(n=100).to_string()},
    ]
